...
public class AudioFrontMicTest extends AndroidTestCase {
    ...
    private final String mTestCaseName = "com.msi.diagnostic.ui.AudioFrontMicPanelView";
    private final String mTestItemName = "isFrontMicRecorded";
    ...
    protected void setUp() throws Exception {
        ...
        mMockView = new MockAudioFrontMicTestCaseView(mApp);
    ...
    public void test_handlePCBAItem_ValidValue_WithResult(){
        ...
        mPresenter = new AudioFrontMICPagePresenter(mMockView,mAudioManager);
        mPresenter.resume();
