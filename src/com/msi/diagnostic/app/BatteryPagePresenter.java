...
public class BatteryPagePresenter extends AbstractTestCasePresenter implements
        ICountDownListener {
    ...
    private BatteryTestCaseView mView;
    private CountDownWaitingTimer mCountDownTimer;

    public IntentFilter mFilter;

    public BatteryPagePresenter(BatteryTestCaseView view) {
        super(view);
        mView = view;
    ...
    private TestResult isValidCurrent() {
        ...
        try {
            ...
            if (!isPlugged) {
                result = new TestResult(TestResult.NONE);
