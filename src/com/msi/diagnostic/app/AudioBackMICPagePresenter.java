...
import com.msi.diagnostic.ui.AudioBackMicTestCaseView;

public class AudioBackMICPagePresenter extends AbstractTestCasePresenter {
    ...
    private AudioBackMicTestCaseView mView;
    ...
    private static class TestItemId {
        public static final int BackMicRecorded = 0;
    }
    ...
    public AudioBackMICPagePresenter(
            AudioBackMicTestCaseView view,
        ...
        mIsHasRecordStart = false;
        mIsHasRecordStop = false;
        mIsHasPlay = false;
    }
    ...
    private void recordStart(){
        ...
        if (mRecordstop) {
            ...
            try {
                ...
                isRecorded(TestItemId.BackMicRecorded, false);
                mView.setmMessageViewText(R.string.audio_back_errinfo);
                e.printStackTrace();
            }
            mRecordstop = false;
        }
    ...
    public void OnButtonClick(int buttonId) {
        ...
        case R.id.audio_pass:
            if (!isNotTest()) {
                isRecorded(TestItemId.BackMicRecorded, true);
            }
            if (!mRecordstop) {
                mMediaRecorder.stop();
            }
